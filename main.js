// Foursquare API Info
const clientId = 'BWUMXQUTQDY2LIFK4S145X23SKTKMHVRWQ0JGUVOED5QQH1A';
const clientSecret = '2YWZEMDQJXR5JP4RLRBBG5AUQDJMFS4DK1KLJGJVXUSZSVU2';
const url = 'https://api.foursquare.com/v2/venues/explore?near=';

// OpenWeather Info
const openWeatherKey = '73c56551213811a48ea57ef7e7dd16c0';
...
const renderForecast = (day) => {
  ...
  console.console.log($weatherDiv);
};
